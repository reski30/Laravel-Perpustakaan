<aside class="main-sidebar">
    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            <li><a href="{{ route('admin.borrow.index') }}"><i class="fa fa-book"></i> <span>Buku sedang
                        dipinjam</span></a></li>
            <li class="treeview">
                <a href="#">
                ...
                <ul class="treeview-menu">
                    <li><a href="{{ route('admin.report.top-book') }}"><i class="fa fa-circle-o"></i> Buku Terfavorit</a></li>
